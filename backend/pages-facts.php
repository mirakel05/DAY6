		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Facts Page</h1>
											...
											<div class="card flex-fill">
												...
												<table class="table table-hover my-0">
													...
													<tr>
															...
															<th class="d-none d-md-table-cell">Keterangan2</th>
															<th class="d-none d-md-table-cell">Nomer2</th>
															<th class="d-none d-md-table-cell">Nama2</th>
															<th class="d-none d-md-table-cell">Keterangan3</th>
															<th class="d-none d-md-table-cell">Nomer3</th>
															<th class="d-none d-md-table-cell">Nama3</th>
															<th class="d-none d-md-table-cell">Keterangan4</th>
														</tr>
													</thead>
													<tbody>
														<?php
														...
														?>
																<tr>
																	...
																	<td class="d-none d-xl-table-cell"><?= $row['NAMA'] ?></span></td>
																	<td class="d-none d-md-table-cell"><?= $row['KETERANGAN2'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['NOMER2'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['NAMA2'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['KETERANGAN3'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['NOMER3'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['NAMA3'] ?></td>
																	<td class="d-none d-md-table-cell"><?= $row['KETERANGAN4'] ?></td>
																	<td>
																		<a href="form/facts/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>
																		<a href="form/facts/hapus.php?id=<?= $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')">Hapus</a>
																	</td>
																</tr>
														<?php
															endwhile;
					...
					<a href="./form/facts/form_tambah.php" class="btn btn-secondary">Tambah</a>
				</div>
			</main>
