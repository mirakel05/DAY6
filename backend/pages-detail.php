		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Detail Page</h1>
											...
											<div class="card flex-fill">
												...
												<table class="table table-hover my-0">
													...
													<tr>
															<th>No</th>
															<th>Kategori</th>
															<th class="d-none d-xl-table-cell">Tanggal Projek</th>
													...
													<tbody>
														...
														?>
																<tr>
																	<td><?=$x++?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['KETERANGAN'] ?></span></td>
																	<td class="d-none d-xl-table-cell"><?= $row['TANGGAL_PROJEK'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['LINK'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['NAMA'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['KETERANGAN'] ?></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/detail/file/<?= $row ['FOTO'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/detail/file/<?= $row ['FOTO1'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/detail/file/<?= $row ['FOTO2'] ?>" alt=""></td>
																	<td>
																		<a href="form/detail/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>
																		<a href="form/detail/hapus.php?id=<?= $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')">Hapus</a>
																	</td>
																</tr>
														<?php
															endwhile;
					...
					<a href="./form/detail/form_tambah.php" class="btn btn-secondary">Tambah</a>
				</div>
			</main>
