		...
		<div class="main">
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<center>
						<p style="font-size: 4rem; font-weight: 800;">SELAMAT DATANG</p>
					</center>
										...
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												<div class="card-header">
													...
													<center>
														<p>
														<h4>Ini merupakan halaman utama dari backend ini.Disini saya akan
															memperlihatkan beberapa halaman yang digunakan/yang ada pada BackEnd saya.
														</h4>
														</p>
													</center>
													<br>
													...
													<div class="container text-left">
														<div class="row align-items-left">
																...
																<div class="card" style="width: 18rem;">
																	<div class="card-body">
																		<ol class="list-group list-group-numbered">
																			<li class="list-group-item">Pages-About</li>
																			<li class="list-group-item">Pages-Facts</li>
																			<li class="list-group-item">Pages-Resume</li>
																			<li class="list-group-item">Pages-Home</li>
																			<li class="list-group-item">Pages-Skill</li>
																			<li class="list-group-item">Pages-Services</li>
																			<li class="list-group-item">Pages-Contact</li>
																			<li class="list-group-item">Pages-Portfolio</li>
																			<li class="list-group-item">Pages-Detail</li>
																			<li class="list-group-item">Pages-Kontak</li>
																			<li class="list-group-item">Pages-Foto</li>
																			<li class="list-group-item">Pages-Navbar</li>
																		</ol>
																	</div>
																</div>
															</div>
															<div class="col">
																<h4>
																	<p>
																	<h3> <strong>Apa Itu BackEnd?</strong></h3>
																	<br>
																	<h5>Back end merupakan bagian dari situs web yang tidak dilihat oleh pelanggan.
																		Back end berurusan dengan data-data di balik layar, ia bertanggung jawab dalam
																		menyimpan dan mengatur data, serta memastikan hal yang ada pada sisi klien berfungsi
																		dan tidak bermasalah.
																		<hr> 
																		<br> 
																		<br>
																		<h3> <strong>Apa Saja Yang Tersedia Di BackEnd Ini?</strong></h3>
																		<br>
																		Di BackEnd ini tersedia Pages-About,Pages-Facts dll seperti yang tertera 
																		disamping .Digunakan untuk mengedit,menghapus, dan menambahkan beberapa
																		konten yang ingin di tampilkan di bagian frontend.
																	</h5>
																	</p>
																</h4>
															</div>
													...
													<br>
													<h3> Ini Merupakan Beberapa Contoh BackEnd Yang Ada</h3>
													<br>
													<br>
													<img src="img/avatars/contoh1.jpg" class="img-fluid" alt="...">
													<hr class="border border-black border-3 opacity-25">
													<img src="img/avatars/contoh2.jpg" class="img-fluid" alt="...">
													<hr class="border border-black border-3 opacity-25">
													<img src="img/avatars/contoh3.jpg" class="img-fluid" alt="...">
												</div>
											</div>
										</div>
									</div>
