										...
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												...
												<form method="POST" action="aksi_edit.php" enctype="multipart/form-data">
													<label for="exampleInputEmail1" class="form-label">Masukan Kategori</label>
													<input type="hidden" class="form-control" value="<?= $row['ID'] ?>" name="ID" placeholder="Masukan">
													<input type="text" class="form-control" value="<?= $row['KATEGORI'] ?>" name="KATEGORI" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Tanggal Projek</label>
													<input type="date" class="form-control" value="<?= $row['TANGGAL_PROJEK'] ?>" name="TANGGAL_PROJEK" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Link</label>
													<input type="text" class="form-control" value="<?= $row['LINK'] ?>" name="LINK" placeholder="Masukan ">
													<br>
