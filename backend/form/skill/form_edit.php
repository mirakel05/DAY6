									...
									<div class="row">
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												...
												<?php 
        											$id = $_GET ['id'];
        											$sql = "SELECT * FROM skill where ID = $id limit 1"; 
        											$data = $conn -> query ($sql);
        											if ($data -> num_rows > 0):
												...
												<br>
												<label for="exampleInputEmail1" class="form-label">Masukan Angka</label>
												<input type="number" class="form-control" value= "<?= $row ['ANGKA'] ?>" name= "ANGKA" placeholder="Masukan ">
												<br>
												<?php 
												endwhile;
												endif;
