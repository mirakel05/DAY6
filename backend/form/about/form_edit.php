										...
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												...
												<form method="POST" action="aksi_edit.php" enctype="multipart/form-data">
													...
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Birthday</label>
													<input type="date" class="form-control" value="<?= $row['BIRTHDAY'] ?>" name="BIRTHDAY" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan No HP</label>
													<input type="text" class="form-control" value="<?= $row['NO_HP'] ?>" name="NO_HP" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Kota</label>
													<input type="text" class="form-control" value="<?= $row['KOTA'] ?>" name="KOTA" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Umur</label>
													<input type="number" class="form-control" value="<?= $row['UMUR'] ?>" name="UMUR" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan Derajat</label>
													<input type="text" class="form-control" value="<?= $row['DERAJAT'] ?>" name="DERAJAT" placeholder="Masukan ">
													<br>
