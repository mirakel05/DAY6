									...
									<div class="row">
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												...
												<br>
												<label for="exampleInputEmail1" class="form-label">Masukan Tanggal1</label>
												<input type="number" min = "1990" max = "2050" class="form-control" value= "<?= $row ['TANGGAL1'] ?>" name= "TANGGAL1" placeholder="Masukan ">
												<br>
												<label for="exampleInputEmail1" class="form-label">Masukan Tanggal2</label>
												<input type="number" min = "1990" max = "2050" class="form-control" value= "<?= $row ['TANGGAL2'] ?>" name= "TANGGAL2" placeholder="Masukan ">
												<br>
