										...
										<div class="col-12 col-lg-9 col-xxl-12 d-flex">
											<div class="card flex-fill">
												...
												<form method="POST" action="aksi_edit.php">
													...
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan RFID</label>
													<input type="text" class="form-control" value="<?= $row['RFID'] ?>" name="RFID" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan EXPO</label>
													<input type="text" class="form-control" value="<?= $row['EXPO'] ?>" name="EXPO" placeholder="Masukan ">
													<br>
													<label for="exampleInputEmail1" class="form-label">Masukan WEB</label>
													<input type="text" class="form-control" value="<?= $row['WEB'] ?>" name="WEB" placeholder="Masukan ">
													<br>
