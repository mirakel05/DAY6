		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Portfolio Page</h1>
											...
											<div class="card flex-fill">
												...
												<table class="table table-hover my-0">
													...
													<tr>
															<th>No</th>
															<th>Keterangan</th>
															<th class="d-none d-xl-table-cell">RFID</th>
															<th class="d-none d-xl-table-cell">EXPO</th>
															<th class="d-none d-xl-table-cell">WEB</th>
														</tr>
													</thead>
													<tbody>
														<?php
														...
														?>
																<tr>
																	...
																	<td class="d-none d-xl-table-cell"><?= $row['RFID'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['EXPO'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['WEB'] ?></td>
																	<td>
																		<a href="form/portfolio/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>
																	</td>
																</tr>
														<?php
															endwhile;
