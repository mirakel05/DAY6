		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Services Page</h1>
											...
											<div class="card flex-fill">
												...
												<table class="table table-hover my-0">
													...
													<tr>
															...
															<th class="d-none d-md-table-cell">Nama1</th>
															<th class="d-none d-md-table-cell">Keterangan1</th>
													...
													<tbody>
														...
														?>
																<tr>
																	...
																	<td class="d-none d-xl-table-cell"><?= $row['NAMA1'] ?></span></td>
																	<td class="d-none d-md-table-cell"><?= $row['KETERANGAN1'] ?></td>
																	...
																	<td>
																		<a href="form/services/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>																	</td>
																</tr>
														<?php
															endwhile;
														endif;
