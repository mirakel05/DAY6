												...
												<table class="table table-hover my-0">
													<thead>
														<tr>
															...
															<th class="d-none d-xl-table-cell">Derajat</th>
													...
													<tbody>
														...
														?>
																<tr>
																	...
																	<td class="d-none d-xl-table-cell"><?= $row['BIRTHDAY'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['NO_HP'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['KOTA'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['UMUR'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['DERAJAT'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['EMAIL'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['KETERANGAN2'] ?></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/about/file/<?= $row ['FOTO'] ?>" alt=""></td>
																	<td>
																		<a href="form/about/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>
																	</td>
																</tr>
														<?php
															endwhile;
