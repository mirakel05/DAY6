		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Navbar Page</h1>
													...
													<tbody>
														...
														?>
																<tr>
																	...
																	<td><img style="width : 100px; height : 100px;" src="form/navbar/file/<?= $row['FOTO'] ?>" alt=""></td>
																	<td>
																		<a href="form/navbar/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>																	</td>
																</tr>
														<?php
															endwhile;
														endif;
