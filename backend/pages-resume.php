		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Resume Page</h1>
													...
													<tbody>
														...
														?>
																<tr>
																	...
																	<td class="d-none d-xl-table-cell"><?= $row['TANGGAL1'] ?> - <?= $row['TANGGAL2'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['ALAMAT'] ?></td>
																	<td class="d-none d-xl-table-cell"><?= $row['KETERANGAN2'] ?></span></td>
																	<td>
																		<a href="form/resume/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>
																		<a href="form/resume/hapus.php?id=<?= $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')">Hapus</a>
																	</td>
																</tr>
														<?php
															endwhile;
					...
					<a href="./form/resume/form_tambah.php" class="btn btn-secondary">Tambah</a>
				</div>
			</main>
