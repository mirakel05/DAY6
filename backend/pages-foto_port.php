											...
											<div class="card flex-fill">
												...
												<table class="table table-hover my-0">
													...
													<tr>
															...
															<th class="d-none d-xl-table-cell">Foto1</th>
															<th class="d-none d-xl-table-cell">Foto2</th>
															<th class="d-none d-xl-table-cell">Foto3</th>
															<th class="d-none d-xl-table-cell">Foto4</th>
															<th class="d-none d-xl-table-cell">Foto5</th>
															<th class="d-none d-xl-table-cell">Foto6</th>
															<th class="d-none d-xl-table-cell">Foto7</th>
															<th class="d-none d-xl-table-cell">Foto8</th>
														</tr>
													</thead>
													<tbody>
														<?php
														...
														?>
																<tr>
																	<!-- <td><?=$x++?></td> -->
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO1'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO2'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO3'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO4'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO5'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO6'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO7'] ?>" alt=""></td>
																	<td><img style = "width : 100px; height : 100px;" src="form/foto_port/file/<?= $row ['FOTO8'] ?>" alt=""></td>
																	<td>
																		<a href="form/foto_port/form_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary">Edit</a>																	</td>
																</tr>
														<?php
															endwhile;
														endif;
